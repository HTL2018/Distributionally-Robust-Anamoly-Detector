...
dr_residual_threshold          = compute_residual_threshold(threshold_param);
...
noise_param.noise_kind  = 1; % 1 - System Noise 
noise_param.Sigma_noise = Sigma_w;
...
noise_param.type = 1; 
DR_out_param     = noise_bounding_ellipsoid_Ver1(noise_param);
DR_P_sys_noise   = DR_out_param.P;

% Type = 2 - Chi Squared Case
disp('Getting Chi Squared Ellipsoid for System Noise');
noise_param.type        = 2; 
chi_squared_out_param   = noise_bounding_ellipsoid_Ver1(noise_param);
...
noise_param.noise_kind  = 2; % 2 - Sensor Noise 
noise_param.Sigma_noise = Sigma_v;
